...
function(t, i, e, s) {
    ...
    function o(i, e) {
        ...
        this.$shoudongs = this.$context.find(".shoudong");
        var s = {
    ...
    o.prototype.initialise = function() {
        ...
        this.updateshoudongs(),
        this.updateDimensions(),
        this.enable(),
        this.queueCalibration(this.calibrationDelay)
    },
    o.prototype.updateshoudongs = function() {
        this.$shoudongs = this.$context.find(".shoudong"),
        this.depths = [],
        this.$shoudongs.css({
            position: "absolute",
        ...
        this.$shoudongs.first().css({
            position: "relative"
        }),
        this.accelerate(this.$shoudongs),
        this.$shoudongs.each(t.proxy(function(i, e) {
    ...
    o.prototype.css = function(i, e, o) {
        ...
        if (!n) for (var a = 0,
        r = this.vendors.length; r > a; a++) if (n = null !== this.vendors[a] ? t.camelCase(this.vendors[a][1] + "-" + e) : e, i.style[n] !== s) {
    ...
    o.prototype.onAnimationFrame = function() {
        ...
        for (var e = 0, s = this.$shoudongs.length; s > e; e++) {
            var o = this.depths[e],
            n = this.$shoudongs[e],
    ...
    var h = {
        ...
        updateshoudongs: o.prototype.updateshoudongs,
